//! Example: H.264 Video Encoding
//!
//! Demonstrates H.264 video encoding using PixelForge with Vulkan Video.
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("PixelForge H.264 Encode Example\n");
